...
require (
	...
	github.com/1119-Labs/perpx-chain/protocol v0.0.0-20260126090022-57382c4c8623
...
require (
	...
	github.com/1119-Labs/slinky v1.3.3 // indirect
...
replace (
	...
	github.com/cosmos/ibc-go/v8 => github.com/1119-Labs/ibc-go/v8 v8.0.0-rc.0.0.20250312180215-8733b3edf43a
...
replace (
	...
	// Use 1119-Labs forks where commits are on default branches
	// cosmos-sdk default is perpx-fork-v0.50.5 (contains our commit)
	cosmossdk.io/store => github.com/1119-Labs/cosmos-sdk/store v1.0.3-0.20240326192503-dd116391188d
	github.com/cometbft/cometbft => github.com/1119-Labs/cometbft v0.38.6-0.20251021155510-74157e3aac09
	github.com/cosmos/cosmos-sdk => github.com/1119-Labs/cosmos-sdk v0.50.6-0.20260122020218-fc117a91b505
	// Fix app-injected messages without signers: https://github.com/1119-Labs/cosmos-sdk/commit/fc117a91b
	github.com/cosmos/iavl => github.com/1119-Labs/iavl v1.1.1-0.20240509161911-1c8b8e787e85
)

replace (
	// Copy over the same replace functions for Cosmos SDK.
	// https://github.com/1119-Labs/cosmos-sdk/blob/fbb26831d28f66e86bfc31283b4be9290929a4a5/go.mod#L171
